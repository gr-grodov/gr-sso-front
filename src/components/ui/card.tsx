...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("font-heading text-base font-medium flex flex-row items-center gap-0", className)}
      {...props}
    />
  )
}
